...
class VidDataGenerator(Sequence):
    ...
    def generate_x(self, vid_files_temp):
        ...
        r_number_1 = random.uniform(0, 1)
        r_number_2 = random.uniform(0, 1)
        ...
        if self.aug:
            ...
            if r_number_1 < 0.5:
                # blur the videos
                X_data_padded = blur_batch(X_data_padded)

            if r_number_2 < 0.5:
                # add noise to the batch
                X_data_padded = add_noise(X_data_padded)
